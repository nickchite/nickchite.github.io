...
export const works = [
  ...
  },
  {
    ...
    collaborators: 'solo',
    duration: '20XX',
    tools: ['Instruction Score', 'Deep Listening'],
  ...
  },
  {
    ...
    embed: {
      ...
      mountId: 'guitar',
      scripts: [
        { src: 'https://d3js.org/d3.v6.min.js', attr: 'data-d3-script' },
        { src: 'https://cdn.jsdelivr.net/npm/tone@14.8.26', attr: 'data-tone-script' },
        { src: '/resources/guitar/src/script.js', attr: 'data-guitar-script', once: false }
      ]
    },
    externalUrl: '',
    externalLabel: 'open project',
  ...
  },
  {
    ...
    duration: '20XX',
    tools: ['Max/MSP', 'OpenSoundControl'],
    cover: '/resources/signal/host.png',
    images: [
  ...
  },
  {
    ...
    tools: ['Arduino Nano', 'I2C', 'OpenSoundControl', 'Max/MSP'],
